...
The kernel is a projection layer, not a replacement for HAPI World's ontology or constitutional entities.
...
- Evidence, provenance, lineage, state, and authority semantics remain governed by HAPI World law.

## Compatibility objective

This boundary allows ABBA, platform infrastructure, I/O, NGIN, NAIRE, VALUE SYSTEM, and products to interoperate using a common vocabulary without creating a second constitutional universe.
